...
prop_orderEquivalency :: Integer -> Bool
prop_orderEquivalency n = factorial n == reverseFactorial n

-- n! must equal n * (n-1)!
prop_splitable :: Integer -> Bool
prop_splitable n = factorial n == n * factorial (n - 1)
...
-- main :: IO ()
main = do
    quickCheck $ forAll genPositiveIntegers prop_orderEquivalency
    quickCheck $ forAll genPositiveIntegers prop_splitable

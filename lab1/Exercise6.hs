...
It doesn't matter if the input is in nnf form already as multiple executions of nnf will leave same result as just one
...
2. Unsimplified form makes it easier to see the work of the algorithm
3. Because of the delay caused by Exercise4 we were running low on time

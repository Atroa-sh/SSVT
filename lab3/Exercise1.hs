...
Weaknesses and strengths of the mutators:
    ...
    removeElements:
        ...
        weakness: The elements that are removed, are always at the end of the list
        Not covered: Empty lists, removing elements inbetween or from the beginning of the list.

    anyList:
        strength: Really large domain of possible lists.
        weakness: Reallly long lists can be generated, causing possible long execution times.
            Values in the list are also random.
        Not covered: Really low chance to generate empty lists.
